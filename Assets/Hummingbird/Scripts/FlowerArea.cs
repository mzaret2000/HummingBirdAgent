...
public class FlowerArea : MonoBehaviour
{
    ...
    // used foro observing relative distance from agent to flower
    ...
    /// </summary>
    /// <param name="parent">The parent of the children the check</param>
        ...
        for(int i = 0; i < parent.childCount; i++)
        {
            ...
            else
            {
                ...
                if (flower != null)
                {
                    ...
                    // Note: there are no flowers that are children of the othere flowers
