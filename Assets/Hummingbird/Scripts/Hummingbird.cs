...
public class Hummingbird : Agent
{
    ...
    [Tooltip("Transform at the tip of the beek")]
    ...
    // Allows for smoother pitch change;
    ...
    // Whehter the agent is frozen (intentionally not flying)
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        // Observe a normalized vector pointing the nearest flower (3 observations)
        sensor.AddObservation(toFlower.normalized);

        // Observe a dot product that indicates whether the beak tip is in front of the flower (1 observation)
        // (+1 means that thee beak tip is directly in front of the flower, -1 means directly behind)
        ...
        // Observe a relative distance from the beak tip to the flower (1 observation)
