...
{
    [Tooltip("The color whene the flower is full")]
    public Color fullFlowerColor = new Color(1f, 0f ,0.3f);

    [Tooltip("The color whene the flower is empty")]
    public Color emptyFlowerColor = new Color(0.5f, 0f, 1f);

    /// <summary>
    /// This is the trigger collider representing the nectar
    /// </summary>
    [HideInInspector]
    public Collider nectarCollider;

    // The solid collider representing the the flower petals
    ...
    /// <summary>
    /// Attempts to recover nectar from the flower
    /// </summary>
    /// <param name="amount">The amount of nectar to remove</param>
    /// <returns>The actual amount of nectar successfully removed</returns>
    public float Feed(float amount)
    {
        //Track hoe much nectar was successfully taken (cannot take more than is available)
